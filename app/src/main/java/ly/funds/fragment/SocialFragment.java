...
import ly.funds.view.FruitView;
import ly.funds.view.SpringScrollView;
import okhttp3.Call;
...
public class SocialFragment extends BaseFragment {
    ...
    private void loginPosts() {
        ...
        OkHttpUtils
                ...
                .addParams("data", "{\"password\":\"" + SPUtils.get(getContext(), "password", "") + "\",\"username\":\"" + SPUtils.get(getContext(), "id", "") + "\"}")
                .build()
